package com.randomchat.randomchat.configuration;
...
public class DatabaseConfiguration {
	...
	public DataSource dataSource() {
		DataSource dataSource = DataSourceBuilder.create().url("jdbc:h2:tcp://localhost/~/test").driverClassName("org.h2.Driver")
